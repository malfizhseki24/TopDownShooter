...
Defines the visual and physics feedback systems for combat: shader-based hit flash, screen flash overlays, impulse-based knockback, and squash/stretch sprite deformation.
## Requirements
