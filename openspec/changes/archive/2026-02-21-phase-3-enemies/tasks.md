...
- [x] 6.3 Test charge telegraph and cooldown
...
- [x] 7.4 Test spawn system with Shadow Wisp only
...
- [x] 9.1 Update player Hitbox to detect enemy layer
- [x] 9.2 Update player.gd _on_hitbox_body_entered for enemy damage
- [x] 9.3 Connect enemy_died signal to GameManager for count tracking
- [x] 9.4 Test full gameplay loop: spawn → combat → death → respawn

## 10. Verification

- [x] 10.1 All 4 enemy types spawn and behave correctly
- [x] 10.2 Global enemy limit (10 max) enforced
- [x] 10.3 Player takes correct damage from each enemy type
- [x] 10.4 Enemies die correctly and decrement count
- [x] 10.5 Hit feedback (flash, knockback) works on all enemies
- [x] 10.6 Death dissolve animation plays on all enemies
